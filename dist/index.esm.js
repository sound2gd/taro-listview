...
class Skeleton extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(View, null,
            React.createElement(View, { style: { opacity: isLoaded ? 1 : 0 } }, this.props.children),
            isLoaded ? ('') : (React.createElement(View, { style: { ...parentRect, backgroundColor: 'white', position: 'fixed', overflow: 'hidden' } },
                bg.map((item, index) => {
                    const { width, height, top, left } = item;
                    return (React.createElement(View, { key: `${item.height}${index}`, style: {
                            background: 'white',
                            width: `${width}px`,
                            height: `${height}px`,
                            top: `${top}px`,
                ...
                list.map((item, index) => {
                    const { width, height, top, left } = item;
                    return (React.createElement(View, { key: `${item.height}${index}`, className: 'skeletonBg', style: {
                            width: `${width}px`,
                            height: `${height}px`,
                            top: `${top}px`,
                            left: `${left}px`,
...
class Page$1 extends Component {
    render() {
        return (React.createElement(View, { className: 'loading-box', "data-color": 'red' },
            React.createElement(View, { style: 'width:100%;height:100%', className: 'lds-rolling' },
                React.createElement(View, { className: 'circle', style: { borderColor: this.props.color } }))));
    }
}
    ...
    throttle(() => {
        setTimeout(() => {
            Taro.createSelectorQuery()
                ...
                // @ts-ignore
                if (Taro[key] && typeof Taro[key] === 'function')
                    Taro[key](indexs);
            });
        }, 0);
    }, 500)();
...
class Page extends Component {
    render() {
        ...
        return (React.createElement(View, null,
            showErrorText && (React.createElement(View, { className: 'errorPage' },
                React.createElement(View, { className: 'marginBottom30' }, "\u554A\u54E6\uFF0C\u7F51\u7EDC\u6084\u6084\u8DD1\u5230\u5916\u661F\u7403\u53BB\u4E86~"),
                React.createElement(View, { className: 'button', onClick: fetchInit }, "\u91CD\u65B0\u52A0\u8F7D"))),
            showRenderError ? this.props.renderError : '',
            showEmptyText && (React.createElement(View, { className: 'noContentTips' }, emptyText)),
...
class ListView extends Component {
    ...
    render() {
        ...
        if (autoHeight) {
            return (React.createElement(ScrollView, { ref: node => {
                ...
                React.createElement(View, { style: { minHeight: "100%", overflowY: "hidden" }, onTouchMove: e => this.touchEvent(e), onTouchEnd: e => this.touchEvent(e), onTouchStart: e => this.touchEvent(e), onTouchCancel: e => this.touchEvent(e) },
                    React.createElement(View
                    // style={trStyle}
                    , { 
                        // style={trStyle}
                        className: 'bodyView', id: this.bodyViewId },
                        React.createElement(View, { style: blockStyle },
                            React.createElement(View, { style: { height: `${damping}px`, marginTop: `-${damping}px` }, className: 'pullDownBlock' },
                                React.createElement(View, { className: 'tip' },
                                    !downLoading && React.createElement(View, { id: this.tipDampTextId }, dampText),
                                    downLoading &&
                                        (this.props.customizeLoading ? (this.props.renderCustomizeLoading) : (React.createElement(Page$1, { color: circleColor }))))),
                            showChildren && this.props.children,
                            React.createElement(Page, { renderError: this.props.renderError, renderEmpty: this.props.renderEmpty, launchError: launchError, launchEmpty: launchEmpty, isError: isError || false, isEmpty: isEmpty || false, emptyText: emptyText || "", fetchInit: this.fetchInit }),
                            footerLoading && (React.createElement(View, { className: 'loading' }, footerLoadingText)),
                            customFooterLoading && this.props.renderFooterLoading,
                            footerLoaded && (React.createElement(View, { className: 'loaded' }, footerLoadedText)),
                            customFooterLoaded && this.props.renderFooterLoaded)))));
        }
        return (React.createElement(Skeleton, { isLoaded: isLoaded || isError, selector: selector },
            React.createElement(ScrollView, { ref: node => {
                    this.scrollView = node;
                ...
                React.createElement(View, { style: { minHeight: "100%", overflowY: "hidden" }, onTouchMove: e => this.touchEvent(e), onTouchEnd: e => this.touchEvent(e), onTouchStart: e => this.touchEvent(e), onTouchCancel: e => this.touchEvent(e) },
                    React.createElement(View, { className: 'bodyView', id: this.bodyViewId },
                        React.createElement(View, { style: blockStyle },
                            React.createElement(View, { style: { height: `${damping}px`, marginTop: `-${damping}px` }, className: 'pullDownBlock' },
                                React.createElement(View, { className: 'tip' },
                                    !downLoading && React.createElement(View, { id: this.tipDampTextId }, dampText),
...
class LazyImage extends Component {
    ...
    render() {
        ...
        return (React.createElement(View, { className: `lazy-image-${this.lazyItem.key} ${this.props.className}` }, this.isLoad(current) ? (React.createElement(View, { className: 'blockLoad' }, this.props.children)) : ('')));
    }
}
LazyImage.options = {
    addGlobalClass: true,
...
export { LazyImage as LazyBlock, ListView, Skeleton, ListView as default };
